...
export enum AppSystemProp {
    ...
    MAX_WEBHOOK_PAYLOAD_SIZE_MB = 'MAX_WEBHOOK_PAYLOAD_SIZE_MB',
    ...
    PASSGRAD_ADMISSION_URL = 'PASSGRAD_ADMISSION_URL',
    PASSGRAD_ADMISSION_SECRET = 'PASSGRAD_ADMISSION_SECRET',
    PASSGRAD_ALLOWED_ORIGINS = 'PASSGRAD_ALLOWED_ORIGINS',
    PASSGRAD_PLATFORM_ID = 'PASSGRAD_PLATFORM_ID',
    PASSGRAD_PROVISIONING_SECRET = 'PASSGRAD_PROVISIONING_SECRET',
    PASSGRAD_API_URL = 'PASSGRAD_API_URL',
    PASSGRAD_ENGINE_CAPABILITY_SECRET = 'PASSGRAD_ENGINE_CAPABILITY_SECRET',
...
export const environmentVariables = {
    hasAppModules(): boolean {
        const environment =
      this.getEnvironment(AppSystemProp.CONTAINER_TYPE) ??
      ContainerType.WORKER_AND_APP
        return [ContainerType.APP, ContainerType.WORKER_AND_APP].includes(
            environment as ContainerType,
        )
    },
