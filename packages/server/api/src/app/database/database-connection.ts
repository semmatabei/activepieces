...
import { PassgradEmbedSessionMintEntity } from '../passgrad/passgrad-embed-session-mint.entity'
import { PassgradLifecycleOutboxEntity } from '../passgrad/passgrad-lifecycle-outbox.entity'
import { PassgradProjectBindingEntity } from '../passgrad/passgrad-project-binding.entity'
...
function getPersistedConnection(): DataSource | null {
    return (
        ((globalThis as Record<string, unknown>)[DB_GLOBAL_KEY] as DataSource) ??
    null
    )
}
