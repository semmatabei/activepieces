...
const callbackPayloadSchema = z
    .object({
        ...
        actorUserId: boundedIdSchema.optional(),
        resumeUrl: z.string().url().max(2048).optional(),
        workflowNodeReference: boundedIdSchema.optional(),
        workflowReference: boundedIdSchema.optional(),
        workflowRunReference: boundedIdSchema.optional(),
        ...
        triggerKind: z.string().trim().max(100).optional(),
        startedAt: z.string().datetime().nullable().optional(),
        finishedAt: z.string().datetime().nullable().optional(),
        sourceSubmissionId: boundedIdSchema.nullable().optional(),
        safeFailureSummary: z.string().max(4096).nullable().optional(),
